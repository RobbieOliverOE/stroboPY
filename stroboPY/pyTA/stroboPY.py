...
class Application(QtWidgets.QMainWindow):
    ...
    def update_d_use_calib(self): #CALIBRATION TO BUT DEALT WITH FROM GEOMETRICAL OPTICS
    ...
    def update_xlabel(self):
        self.xlabel = 'Distance (nm)' if self.use_calib else 'Pixel Number'
    ...
    def pixels_to_nms(self):
        ...
        return np.linspace(0, self.num_pixels-1,self.num_pixels)*self.nm_per_pixel
